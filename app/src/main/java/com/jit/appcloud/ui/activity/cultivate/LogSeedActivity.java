...
import com.jit.appcloud.ui.presenter.LogSeedAtPresenter;
 ...
 *         discription:日常种苗记录
 */
public class LogSeedActivity extends BaseActivity<ILogAtView,LogSeedAtPresenter> implements ILogAtView {
    ...
    @Override
    protected LogSeedAtPresenter createPresenter() {
        return new LogSeedAtPresenter(this);
    }
    ...
    private void setToolbarTitle(int position){
        if (mPondList != null && mPondList.size()!=0){
            mTvToolbarTitle.setText(String.format(getString(R.string.str_title_seed),mPondList.get(position)));
        }else {
            mTvToolbarTitle.setText(getString(R.string.str_title_seed_empty));
