...
import com.jit.appcloud.ui.presenter.LogFeedAtPresenter;
 ...
 *         discription:日常投放日志
 */
public class LogFeedActivity extends BaseActivity<ILogAtView,LogFeedAtPresenter> implements ILogAtView {
    ...
    @Override
    protected LogFeedAtPresenter createPresenter() {
        return new LogFeedAtPresenter(this);
    }
    ...
    private void setToolbarTitle(int position){
        if (mPondList != null && mPondList.size()!=0){
            mTvToolbarTitle.setText(String.format(getString(R.string.str_title_feed),mPondList.get(position)));
        }else {
            mTvToolbarTitle.setText(getString(R.string.str_title_feed_empty));
