...
import com.jit.appcloud.ui.presenter.LogDeviceAtPresenter;
import com.jit.appcloud.ui.presenter.LogWaterAtPresenter;
 ...
 *         discription: 设备日志
 */
public class LogDeviceActivity extends BaseActivity<ILogAtView,LogDeviceAtPresenter> implements ILogAtView {
    ...
    @Override
    protected LogDeviceAtPresenter createPresenter() {
        return new LogDeviceAtPresenter(this);
    }
    ...
    private void setToolbarTitle(int position){
        if (mPondList != null && mPondList.size()!=0){
            mTvToolbarTitle.setText(String.format(getString(R.string.str_title_device),mPondList.get(position)));
        }else {
            mTvToolbarTitle.setText(getString(R.string.str_title_device_empty));
        }
    }
