 ...
 *         discription:日常水质活动
 */
public class LogWaterDtActivity extends BaseActivity<ILogAtView, LogWaterAtPresenter> implements ILogAtView {
    ...
    @Override
    protected LogWaterAtPresenter createPresenter() {
        return new LogWaterAtPresenter(this);
    }
    ...
    private void setToolbarTitle(int position){
        if (mPondList != null && mPondList.size()!=0){
            mTvToolbarTitle.setText(String.format(getString(R.string.str_title_water),mPondList.get(position)));
        }else {
            mTvToolbarTitle.setText(getString(R.string.str_title_water_empty));
