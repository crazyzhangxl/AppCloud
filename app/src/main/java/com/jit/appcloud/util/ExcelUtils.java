...
public class ExcelUtils {
	 ...
	 * @param emitter
	 */
	public static void initExcel(String fileName, String[] colName, String tableName, ObservableEmitter<Boolean> emitter) {
		format();
	...
	public static <T> void writeObjListToExcel(List<T> objList, String fileName, Context c, ObservableEmitter<Boolean> emitter) {
