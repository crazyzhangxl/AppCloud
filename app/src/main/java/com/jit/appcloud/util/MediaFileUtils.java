...
public class MediaFileUtils {
    ...
    static {
        ...
        addFileType("MP4", FILE_TYPE_MP4, "ic_func_video/mp4");
        addFileType("M4V", FILE_TYPE_M4V, "ic_func_video/mp4");
        addFileType("3GP", FILE_TYPE_3GPP, "ic_func_video/3gpp");
        addFileType("3GPP", FILE_TYPE_3GPP, "ic_func_video/3gpp");
        addFileType("3G2", FILE_TYPE_3GPP2, "ic_func_video/3gpp2");
        addFileType("3GPP2", FILE_TYPE_3GPP2, "ic_func_video/3gpp2");
        addFileType("WMV", FILE_TYPE_WMV, "ic_func_video/x-ms-wmv");
